...
import 'menu/components/chip_item.dart';
import 'menu/components/choose_tab_item.dart';
import 'menu/components/colors_item.dart';
import 'menu/components/gradient_item.dart';
import 'menu/components/heading.dart';
import 'menu/components/radio_item.dart';
import 'menu/data.dart';
import 'menu/model/badge.dart';
import 'menu/model/choice_value.dart';
...
class _State extends State<MainMenu> with SingleTickerProviderStateMixin {
  ...
  Color _barColor = AppStyles.primaryColorBlackKnow;
      ...
      child: Scaffold(
        ...
        bottomNavigationBar: _badge == null
            ? ConvexAppBar(
                ...
                activeColor: AppStyles.primaryColorWhite,
                gradient: _gradient,
                controller: _tabController,
