                ...
                Expanded(
                  child: TextFormField(
                    ...
                    decoration: InputDecoration(
                      ...
                      hintStyle: TextStyle(color: AppStyles.primaryColorWhite),
                      focusColor: AppStyles.primaryColorWhite,
                      hoverColor: AppStyles.primaryColorWhite,
                      ...
                      prefixIcon: GestureDetector(
                          ...
                          child: IconButton(
                            icon: Image.asset(
                                'assets/images/icons/image-small.png'),
                            iconSize: 20,
                            onPressed: () async {
                              focusNode.unfocus();
                              focusNode.canRequestFocus = false;
